...
const TEST_DEFINITION_PRIORITY: Record<string, number> = {
  ...
  "schedule-entry-lock-compliance": 47,
...
const DEFINITION_CC_GROUPS: Record<string, { key: string; title: string; description: string; order: number }> = {
  ...
  "schedule-entry-lock-capabilities": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-time-offset": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-time-dependency": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-timezone-roundtrip": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-weekday-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-yearday-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-daily-repeating-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-compliance": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、时区切换、Time CC 时间依赖与 schedule 读取", order: 40 },
