...
const TEST_DEFINITION_PRIORITY: Record<string, number> = {
  ...
  "schedule-entry-lock-capabilities": 40,
  "schedule-entry-lock-time-offset": 41,
  "schedule-entry-lock-time-dependency": 42,
  "schedule-entry-lock-timezone-roundtrip": 43,
  "schedule-entry-lock-weekday-read": 44,
  "schedule-entry-lock-yearday-read": 45,
  "schedule-entry-lock-daily-repeating-read": 46,
  "schedule-entry-lock-weekday-lifecycle": 47,
  "schedule-entry-lock-yearday-lifecycle": 48,
  "schedule-entry-lock-daily-repeating-lifecycle": 49,
  "schedule-entry-lock-empty-slot-report": 50,
  "schedule-entry-lock-slot-boundary": 51,
  "schedule-entry-lock-enable": 52,
  "schedule-entry-lock-enable-all": 53,
  "schedule-entry-lock-type-switch": 54,
  "schedule-entry-lock-manual-auth": 55,
  "schedule-entry-lock-compliance": 56,
...
const DEFINITION_CC_GROUPS: Record<string, { key: string; title: string; description: string; order: number }> = {
  ...
  "schedule-entry-lock-capabilities": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-time-offset": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-time-dependency": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-timezone-roundtrip": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-weekday-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-yearday-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-daily-repeating-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-weekday-lifecycle": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-yearday-lifecycle": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-daily-repeating-lifecycle": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-empty-slot-report": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-slot-boundary": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-enable": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-enable-all": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-type-switch": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-manual-auth": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
  "schedule-entry-lock-compliance": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、读写生命周期、Enable 与实际生效验证", order: 40 },
