...
const TEST_DEFINITION_PRIORITY: Record<string, number> = {
  ...
  "schedule-entry-lock-weekday-read": 43,
  "schedule-entry-lock-yearday-read": 44,
  "schedule-entry-lock-daily-repeating-read": 45,
  "schedule-entry-lock-compliance": 46,
...
const DEFINITION_CC_GROUPS: Record<string, { key: string; title: string; description: string; order: number }> = {
  ...
  "schedule-entry-lock-capabilities": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-time-offset": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-time-dependency": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-weekday-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-yearday-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-daily-repeating-read": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
  "schedule-entry-lock-compliance": { key: "schedule-entry-lock", title: "Schedule Entry Lock CC (0x4E)", description: "计划表能力、Time Offset、Time CC 时间依赖与 schedule 读取", order: 40 },
